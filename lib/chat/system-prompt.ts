...
- Обзор (/overview) — KPI, графики лидов, расходов, выручки, ROMI по месяцам
...
- Выручка (умный расчёт) = для каждого результативного лида: если указаны типы товаров — берётся средний avg_check всех его типов, иначе глобальный средний чек
